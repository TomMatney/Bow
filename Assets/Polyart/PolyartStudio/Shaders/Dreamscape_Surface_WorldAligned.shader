...
Shader "Polyart/Dreamscape Surface World Aligned"
{
	Properties
	{
		...
		[ASEEnd]_SmoothnessIntensity("Smoothness Intensity", Range( -1 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float vertexToFrag29_g17 = ase_worldNormal.x;
				o.ase_texcoord7.x = vertexToFrag29_g17;
				float vertexToFrag31_g17 = ase_worldNormal.z;
				o.ase_texcoord7.y = vertexToFrag31_g17;
				
				float vertexToFrag29_g16 = ase_worldNormal.x;
				o.ase_texcoord7.z = vertexToFrag29_g16;
				float vertexToFrag31_g16 = ase_worldNormal.z;
				o.ase_texcoord7.w = vertexToFrag31_g16;
				
				float vertexToFrag29_g15 = ase_worldNormal.x;
				o.ase_texcoord8.x = vertexToFrag29_g15;
				float vertexToFrag31_g15 = ase_worldNormal.z;
				o.ase_texcoord8.y = vertexToFrag31_g15;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 break9_g17 = ( WorldPosition * ( abs( _Tiling ) * -1.0 ) );
				...
				float vertexToFrag29_g17 = IN.ase_texcoord7.x;
				float4 lerpResult33_g17 = lerp( XZ_Texture21_g17 , YZ_Texture23_g17 , abs( vertexToFrag29_g17 ));
				...
				float vertexToFrag31_g17 = IN.ase_texcoord7.y;
				float4 lerpResult36_g17 = lerp( lerpResult33_g17 , XY_Texture19_g17 , abs( vertexToFrag31_g17 ));
				
				float3 break9_g16 = ( WorldPosition * ( abs( _Tiling ) * -1.0 ) );
				...
				float vertexToFrag29_g16 = IN.ase_texcoord7.z;
				float4 lerpResult33_g16 = lerp( XZ_Texture21_g16 , YZ_Texture23_g16 , abs( vertexToFrag29_g16 ));
				...
				float vertexToFrag31_g16 = IN.ase_texcoord7.w;
				float4 lerpResult36_g16 = lerp( lerpResult33_g16 , XY_Texture19_g16 , abs( vertexToFrag31_g16 ));
				float3 unpack97 = UnpackNormalScale( lerpResult36_g16, _NormalIntensity );
				unpack97.z = lerp( 1, unpack97.z, saturate(_NormalIntensity) );
				
				float3 break9_g15 = ( WorldPosition * ( abs( _Tiling ) * -1.0 ) );
				...
				float vertexToFrag29_g15 = IN.ase_texcoord8.x;
				float4 lerpResult33_g15 = lerp( XZ_Texture21_g15 , YZ_Texture23_g15 , abs( vertexToFrag29_g15 ));
				...
				float vertexToFrag31_g15 = IN.ase_texcoord8.y;
				float4 lerpResult36_g15 = lerp( lerpResult33_g15 , XY_Texture19_g15 , abs( vertexToFrag31_g15 ));
				
				float3 Albedo = lerpResult36_g17.rgb;
				float3 Normal = unpack97;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = ( ( 1.0 - lerpResult36_g15 ) * _SmoothnessIntensity ).r;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 ase_worldNormal = TransformObjectToWorldNormal(v.ase_normal);
				float vertexToFrag29_g17 = ase_worldNormal.x;
				o.ase_texcoord2.x = vertexToFrag29_g17;
				float vertexToFrag31_g17 = ase_worldNormal.z;
				o.ase_texcoord2.y = vertexToFrag31_g17;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 YZ_Coord15_g17 = appendResult14_g17;
				float4 YZ_Texture23_g17 = tex2D( _AlbedoTexture, YZ_Coord15_g17 );
				float vertexToFrag29_g17 = IN.ase_texcoord2.x;
				float4 lerpResult33_g17 = lerp( XZ_Texture21_g17 , YZ_Texture23_g17 , abs( vertexToFrag29_g17 ));
				float2 appendResult10_g17 = (float2(break9_g17.x , break9_g17.y));
				float2 XY_Coord11_g17 = appendResult10_g17;
				float4 XY_Texture19_g17 = tex2D( _AlbedoTexture, XY_Coord11_g17 );
				float vertexToFrag31_g17 = IN.ase_texcoord2.y;
				float4 lerpResult36_g17 = lerp( lerpResult33_g17 , XY_Texture19_g17 , abs( vertexToFrag31_g17 ));
...
/*ASEBEGIN
Version=18800
594;215;2499;1563;4877.145;500.5229;1.6;True;True
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;110;-2759.431,322.9893;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;111;-2759.431,322.9893;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;Polyart/Dreamscape Surface World Aligned;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;112;-2759.431,322.9893;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;113;-2759.431,322.9893;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;114;-2759.431,322.9893;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;115;-2759.431,322.9893;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;111;0;109;25
WireConnection;111;1;97;0
WireConnection;111;4;103;0
ASEEND*/
//CHKSM=0490CC8A7187142BC3D28A7F0B9ED1DAB3C0B76F